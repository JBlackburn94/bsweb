...
export default function Hero() {
  ...
  return (
    <section className="grid grid-cols-2 grid-rows-2 w-full h-screen gap-10 p-10 border-2 border-green-400">
      <div className="row-span-2 col-span-1 border-2 flex justify-center items-center border-white rounded-2xl skeleton">
        call to action
      </div>
      <div className="row-span-1 col-span-1 border-2 flex justify-center items-center border-white rounded-2xl skeleton">
        spotify
      </div>
      <div className="row-span-1 col-span-1 border-2 flex justify-center items-center border-white rounded-2xl skeleton">
        mailing
